...
WORKING_DIR=/XXXXX/OGRrice2017_ITS

# Specify primer sequences (forward...reverse_revcomp, reverse...forward_revcomp)
## ---------- ITS1_F_KYO1 - ITS2_KYO2 (RevComp)
PRIMER_FOR_READ=^CTHGGTCATTTAGAGGAASTAA...GATGAAGAACGYAGYRAA
PRIMER_REV_READ=^TTYRCTRCGTTCTTCATC...TTASTTCCTCTAAATGACCDAG
...
-A $PRIMER_REV_READ \
-n 2 \
-o ../${OUTPUT_DIR}/01_temp/${file%_ITS1FKYO1.forward.fastq.gz}_checked_R1.fastq.gz \
-p ../${OUTPUT_DIR}/01_temp/${file%_ITS1FKYO1.forward.fastq.gz}_checked_R2.fastq.gz \
${file} \
