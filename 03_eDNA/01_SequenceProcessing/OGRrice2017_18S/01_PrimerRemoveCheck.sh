...
WORKING_DIR=/XXXXX/OGRrice2017_18S

# Specify primer sequences (forward...reverse_revcomp, reverse...forward_revcomp)
## ----------- Euk1391f - EukBr (RevComp)
PRIMER_FOR_READ=^GTACACACCGCCCGTC...GTAGGTGAACCTGCAGAAGGATCA
PRIMER_REV_READ=^TGATCCTTCTGCAGGTTCACCTAC...GACGGGCGGTGTGTAC
...
-A $PRIMER_REV_READ \
-n 2 \
-o ../${OUTPUT_DIR}/01_temp/${file%_Euk1391f.forward.fastq.gz}_checked_R1.fastq.gz \
-p ../${OUTPUT_DIR}/01_temp/${file%_Euk1391f.forward.fastq.gz}_checked_R2.fastq.gz \
${file} \
