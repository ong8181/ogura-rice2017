...
#### Eukaryote (18S) sequence analysis by DADA2
####
...
# Load sequence reads
path <- "/XXXXX/OGRrice2017_18S/01_PrimerRemoveCheckOut/"
...
out <- filterAndTrim(fnFs, filtFs, fnRs, filtRs,
                     ...
                     truncLen = c(110, 110), # For Euk1391f-EukBr
...
seqtab2 <- seqtab[,nchar(colnames(seqtab)) %in% seq(100,160)] # For 18S
#seqtab2 <- seqtab
