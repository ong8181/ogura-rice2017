...
sample_sheet <- read.csv("../sampledata_all/20180323_RMR-080_16S_SampleSheet.csv")

# Set parameters
std_copy_n <- c(50000,25000,12500,5000,2500)
...
writeLines(capture.output(sessionInfo()),
           sprintf("00_SessionInfo/06_SessionInfo_STDcheckConv_%s.txt", substr(Sys.time(), 1, 10)))
