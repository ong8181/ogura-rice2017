...
WORKING_DIR=/XXXXX/OGRrice2017_COI

# Specify primer sequences (forward...reverse_revcomp, reverse...forward_revcomp)
## ----------- mlCOIintF - HCO2198 (RevComp)
PRIMER_FOR_READ=^GGWACWGGWTGAACWGTWTAYCCYCC...TGATTTTTTGGTCACCCTGAAGTTTA
PRIMER_REV_READ=^TAAACTTCAGGGTGACCAAAAAATCA...GGRGGRTAWACWGTTCAWCCWGTWCC
...
-A $PRIMER_REV_READ \
-n 2 \
-o ../${OUTPUT_DIR}/01_temp/${file%_mlCOIintF.forward.fastq.gz}_checked_R1.fastq.gz \
-p ../${OUTPUT_DIR}/01_temp/${file%_mlCOIintF.forward.fastq.gz}_checked_R2.fastq.gz \
${file} \
